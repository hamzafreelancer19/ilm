...
This document lists Vercel platform error codes, their category, and the typical HTTP status code returned.
...
The following errors indicate platform/internal issues. If you encounter one of these, contact Vercel support.
...
If you want this file in a different format (JSON, YAML) or added to a frontend debug page, tell me and I will add it.
